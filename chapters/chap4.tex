...
The earliest version of the software mentioned in \chapref{sec:neural-signals} was published in 2016 \cite{mohammed2016integrative}
...
\subsection{Correlation, Confounding Signals, and Non-linear dyanamics}
\label{sec:correlation-confounding-signals-and-non-linear-dyanamics}

\subsection{Motion Artifact}
\label{sec:motion-artifact}
