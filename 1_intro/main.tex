\chapter{
  Introduction: Background and Literature Review} \label{introduction-background-and-literature-review} \thispagestyle{myheadings} 
...
\section{
  Optical Imaging of Neural Activity}\label{optical-imaging-of-neural-activity} 
...
\section{
  Procedures for Calcium Imaging}\label{procedures-for-calcium-imaging} 
...
\section{
  Computer Software Environments for Image Processing}\label{computer-software-environments-for-image-processing} 
...
\section{
  Computational Resources for Processing Large Data Sets}\label{computational-resources-for-processing-large-data-sets} 
