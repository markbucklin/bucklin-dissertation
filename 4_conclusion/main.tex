...
\chapter{
  Discussion} \label{chapter:discussion-the-last-mile-in-computing-for-clinicians-engineers-and-research-scientists} \thispagestyle{myheadings}
...
\subsection{
	Correlation, Confounding Signals, and Non-linear dyanamics}\label{correlation-confounding-signals-and-non-linear-dyanamics}

\subsection{Motion Artifact}\label{motion-artifact}

\section{Exponential Expansion in Data Volume}\label{exponential-expansion-in-data-volume}
...
\subsection{
	Fields sharing these challenges}\label{fields-sharing-this-challenges}
...
\subsection{
	Technological Opportunities to Expect}\label{technological-opportunities-to-expect}
...
\section{
  Clinical translation potential}\label{clinical-translation-potential}
...
\section{
  Cranial Window}\label{cranial-window}
...
\subsection{
	Critical Elements}\label{critical-elements}
...
\subsection{
	Staging Implant Installation \& Tissue Access}\label{staging-implant-installation-tissue-access}
...
\subsection{
	Design Adaptation}\label{design-adaptation}
...
\subsection{
	Rapid fabrication}\label{rapid-fabrication} The rapid iterative process used here was made possible by using a combination of widely available rapid prototyping procedures, 3D-printing and laser-cutting.
