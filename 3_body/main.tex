\chapter{
  Neural Signals: Computational considerations, interpretation and usage} \label{neural-signals-computational-considerations-interpretation-and-usage} \thispagestyle{myheadings} 
...
\begin{figure}[htb]\centering
	\includegraphics[height=12cm]{img/trgb-013.png}
	\caption{caption}
\end{figure}
